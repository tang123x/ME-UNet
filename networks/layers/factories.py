# From https://github.com/Project-MONAI/MONAI/blob/dev/monai/networks/layers/factories.py
...
from ..norms.conditional_instance_norm import ConditionalInstanceNorm1d, ConditionalInstanceNorm2d, ConditionalInstanceNorm3d
...
def instance_cond_factory(dim: int) -> type[ConditionalInstanceNorm1d | ConditionalInstanceNorm2d |ConditionalInstanceNorm3d]:
    """
        Condirional Instance normalization layers in 1,2,3 dimensions.
